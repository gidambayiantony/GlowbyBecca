...
import { WHATSAPP_NUMBER, INSTAGRAM_URL, getWhatsAppLink } from "@/data/products";
        ...
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            ...
            <p className="text-muted-foreground mt-3 max-w-md mx-auto">
              Have a question or ready to order? Hit us up on WhatsApp for the fastest response.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
              <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer" className="block mb-8">
                <Button size="lg" className="w-full gap-3 text-lg py-6 neon-glow">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon: Instagram, label: "Instagram", value: "@fitness_fanatics254", href: INSTAGRAM_URL },
                  { icon: MapPin, label: "Delivery", value: "Nationwide delivery across Kenya", href: undefined },
                ].map((item) => (
